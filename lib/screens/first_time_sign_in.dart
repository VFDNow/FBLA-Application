        ...
        children: [
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                onPressed: () {
                  pageController.animateToPage(0, duration: Duration(milliseconds: 750), curve: Curves.easeInOutCubic);
                },
              ...
              ElevatedButton(
                onPressed: (selectedType != null) ? () {
                  ...
                  db.collection('users').doc(FirebaseAuth.instance.currentUser?.uid).set({
                    ...
                    'User Type': selectedType == EducatorType.student ? 'Student' : 'Teacher',
                  }).then((value) {
                    Navigator.pushReplacementNamed(context, Constants.homeRoute);
                  }).onError((error, stackTrace) {
                    GlobalWidgets(context).showSnackBar(content: "Error Creating User!", backgroundColor: Colors.red);
                  });
                } : null,
          ...
          ElevatedButton(
            onPressed: () {
              if (_nameFormKey.currentState!.validate()) {
                pageController.animateToPage(1, duration: Duration(milliseconds: 750), curve: Curves.easeInOutCubic);
              } else {
                GlobalWidgets(context).showSnackBar(content: "Please Enter Your Name", backgroundColor: Colors.red);
              }
            },
            child: const Text('Next'),
          ),
